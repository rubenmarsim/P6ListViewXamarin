namespace ListView_XamarinForms.Services.Navigation
{
    ...
    public class NavigationService : INavigationService
    {
        private IDictionary<Type, Type> viewModelRouting = new Dictionary<Type, Type>()
        {
            ...
            { typeof(BasicViewModel), typeof(BasicView) },
            { typeof(CustomCellViewModel), typeof(CustomCellView) },
            { typeof(DataBindingViewModel), typeof(DataBindingView) },
            { typeof(ImageCellViewModel), typeof(ImageCellView) },
            { typeof(PerformanceViewModel), typeof(PerformanceView) },
